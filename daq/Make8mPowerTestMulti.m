...
numCellsPerHolo = 1;% Set this to change number of simultaneous cells (default 5)

% P1= [.05 0.075]; %[10:15:100]/1000; %round(10.^(linspace(log10(15),log10(140),9)))./1000; [.01 .025 .04 .055 .07 .085 0.1 0.115 0.13 0.145];%[0.05 0.1]; %[.05 .06 .07 .08 .09 .1 .125];%[0.05 .1 .15];%List of Powers To Use
% P1= [20:15:100]/1000; 
...
% cellsToUse = spreadOutTargetCells([visCells 2 3],numCellsPerHolo,holoRequest,0); %cellsToCalib; 0; %0; %Put List of Targets to shoot here, or zero to use all available.
cellsToUse = 0;
